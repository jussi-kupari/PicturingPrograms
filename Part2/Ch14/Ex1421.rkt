...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Ex1421) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Worked Exercise 14.2.1
; Modify exercise 10.2.5 so that it stops as soon as the user
; presses a key on the keyboard. For now it’s “any key”.
...
;; Counter KeyEv -> Boolean
;; Given Counter and  key-event, stop with key-event

(define (key-press? c ke)
  (stop-with ke))