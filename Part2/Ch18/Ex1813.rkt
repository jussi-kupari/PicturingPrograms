...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Ex1813) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (add-dot SCENE 20 40 "drag")(place-image DOT 20 40 SCENE))
(check-expect (add-dot SCENE 20 40 "enter") SCENE)

(define (add-dot sc x y me)
  (cond
    [(mouse=? me "drag") (place-image DOT x y sc)]
    [else sc]))
