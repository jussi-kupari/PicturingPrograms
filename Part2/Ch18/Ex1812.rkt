...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Ex1812) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; 
...
(check-expect (add-dot SCENE 20 40 "button-up")(place-image DOT 20 40 SCENE))
(check-expect (add-dot SCENE 20 40 "enter") SCENE)

(define (add-dot sc x y me)
  (cond
    [(mouse=? me "button-up") (place-image DOT x y sc)]
    [else sc]))
