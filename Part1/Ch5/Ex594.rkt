...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Ex594) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require picturing-programs)

; Exercise 5.9.4
; Add an inventory to the checkerboard2 function of Exercise 5.8.3.
