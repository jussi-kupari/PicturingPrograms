...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Ex2161) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Worked Exercise 21.6.1
; Write an animation of a picture that moves steadily to the right or left,
; say 3 pixels per second. If the user presses the right-arrow key, the picture
; starts moving to the right, and if the user presses the left-arrow key, the
; picture starts moving to the left.
...
(check-expect (next-dot (make-dot 50 -2)) (make-dot 48 -2))
