...
; Exercise 23.2.6
; Develop a function add-vote-for that takes in a string (representing a candidate’s name) and a
; list of candidate structures, and returns a list of candidate structures in which that candidate
; has one more vote (and all the others are unchanged). You may assume that no name appears more
...
;; Given a string (name) and a LOC, produces the LOC with one vote added to the name in question.
(check-expect
