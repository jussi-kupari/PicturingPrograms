...
; Exercise 23.2.1
; Develop a function substitute that takes in two strings and a list of strings,
; and returns a list the same length as the given list, but with all occurrences
...
;; Given two strings and a LOS, replaced all occurrences of the first string with the second.
