...
; Exercise 23.2.2
; Develop a function remove-all that takes in a string and a list of strings,
; and returns the same list but with all occurrences (if there are any) of the given string removed.
; 
; For example,
; (check-expect
