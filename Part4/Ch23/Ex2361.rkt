...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Ex2361) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|Exercise 23.6.1
...
;; Given a number and a LON, inserts the number at the correct position
;; ASSUME LON is already sorted!
