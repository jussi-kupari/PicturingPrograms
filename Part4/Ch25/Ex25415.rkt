...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Ex25415) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|Exercise 25.4.15
...
(time (lcsubsequence "mickey mouse" "minnie moose"))
cpu time: 6875 real time: 6977 gc time: 156
|#
