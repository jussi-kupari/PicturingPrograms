...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Ex25410) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
#|Exercise 25.4.10
Develop a function binary-mult that takes in two natural numbers and
returns their product, using the binary template (and not using the built-in + or *
functions).
