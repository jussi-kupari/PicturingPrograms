...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Ex2743_wip) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|Exercise 27.4.3
...
Note: At first I had col1 variable both the outer and inner functions and that caused the
